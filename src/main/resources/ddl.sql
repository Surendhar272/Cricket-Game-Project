CREATE DATABASE cricket_game_db;
use cricket_game_db;
...
CREATE TABLE RESULTS_SUMMARY(RESULT_SUMMARY_DB_ID INT PRIMARY KEY AUTO_INCREMENT, MATCHS_DB_ID INT NOT NULL, TEAM_DB_ID INT NOT NULL, PLAYER_DB_ID INT, SCORE INT NOT NULL, BALLS_CONSUMED INT NOT NULL, FOREIGN KEY(MATCHS_DB_ID) REFERENCES MATCHS(MATCHS_DB_ID),FOREIGN KEY(TEAM_DB_ID) REFERENCES TEAM(TEAM_DB_ID));
